...
struct segment_tree{
	...
	void update(int rt,int l=1,int r=n,int x,int y,int v){
		
	}
	
	int query(int rt=1,int l=1,int r=n,int x,int y){
		if(l)
	}
} st;
