...
void SOLVE(int Case){
	...
	cin>>x3>>y3;
	int ans=1;
	if(x1<=x2&&x1<=x3) ans+=min(x2,x3)-x1;
	else if(x1>=x2&&x1>=x3) ans+=x1-max(x2,x3);
	if(y1<=y2&&y1<=y3) ans+=min(y2,y3)-y1;
	else if(y1>=y2&&y1>=y3) ans+=y1-max(y2,y3);
	cout<<ans<<endl;
}
