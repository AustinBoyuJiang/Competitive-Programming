...
int t,n,dp[A],a[N];
int tot,isPrime[A],prime[A],low[A];
...
//	rep(i,0,A-1){
//		if(i%2==0||i>=3&&isPrime[i]){
//			continue;
//		}
//		cout<<i<<" "<<dp[i]<<" "<<low[i]<<" "<<dp[low[i]]<<endl;
//	}
	cin>>t;
	while(t--){
		cin>>n;
