/*
 * Author: Austin Jiang
 * Date: 5/21/2023 11:43:22 PM
 * Problem: LuoTianyi and the Floating Islands (Easy Version)
 * Source:
 * Description:
*/
...
void dfs3(int u,int fa){
	if(u!=1){
		dp[u][0]=dp[fa][0]+dp[fa][1]-dp[u][1]+n-2*siz[u];
		dp[u][0]%=MOD;
	}
	for(int v:e[u]){
		if(v==fa) continue;
