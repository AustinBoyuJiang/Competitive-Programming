...
int n,ans,c[N][N],dp[N][N];

int dfs(int l,int r);

int pmt(int rt,int l,int r){
	if(l==r) return c[rt][l];
	if(l>r) return 0;
	int res=INF;
	rep(i,l+1,r){
		chkmin(res,pmt(rt,i+1,r)+c[rt][l]+dfs(l,i));
	}
	return res;
}
...
int dfs(int l,int r){
	...
	dp[l][r]=INF;
	rep(i,l+1,r){
		chkmin(dp[l][r],pmt(l,i+1,r)+c[l][l+1]+dfs(l+1,i));
	}
	return dp[l][r];
}
