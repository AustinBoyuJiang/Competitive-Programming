...
void solve_J(){
	...
	rep(i,1,n){
		...
		int v=q[i].sec;
		g[x%2][y%2]+=v;
		cout<<(g[1][1]-g[1][0]-g[0][1]+g[0][0]==0&&(g[0][1]-g[1][0])%2==0?"YES":"NO")<<endl;
	}	
}
...
//		cout<<g[1][0]<<" "<<g[1][1]<<endl;
		cout<<((g[0][0]+g[1][1]-g[0][1]-g[1][0])%2==0&&(g[0][0]+g[1][1]+g[0][1]+g[1][0])%4==0?"YES":"NO")<<endl;
	}	
}
