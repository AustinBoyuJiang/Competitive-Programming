...
inline void SOLVE(int Case){
	...
	rep(i,1,m){
		int l=q[i].l,r=q[i].r,ok=0;
		for(int a=1;a*a<q[i].x;a++){
			if(q[i].x%a) continue;
			int b=q[i].x/a;
			int res1=flag[r][itr[r]++].sec;
			int res2=flag[r][itr[r]++].sec;
			int res3=flag[l-1][itr[l-1]++].sec;
			int res4=flag[l-1][itr[l-1]++].sec;
